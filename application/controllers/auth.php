	...
	class Auth extends CI_Controller {
		...
		function index()
		{
			...
			elseif (!$this->ion_auth->is_admin()) //remove this elseif if you want to enable this for non-admins
			{
				...
				return show_error('Solo el Administrador puede ver esta página.');
			}
			else
			{
		...
		function create_user()
		{
			...
			//validate form input
			$this->form_validation->set_rules('first_name', $this->lang->line('create_user_validation_fname_label'), 'trim|required|min_length[5]');		
